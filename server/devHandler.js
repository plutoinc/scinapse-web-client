...
var s3 = require("s3");
var DeployConfig = require("../scripts/deploy/config");
...
function donwloadSourcesFromS3(branch) {
    return new Promise(function (resolve, reject) {
        ...
        var downloader = s3client.downloadDir(params);
...
exports.ssr = function (event, context) { return __awaiter(_this, void 0, void 0, function () {
    var branch, bundle, app, binaryMimeTypes, server;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                app = bundle.ssr;
                binaryMimeTypes = ["application/xml", "text/xml", "text/html", "application/xml"];
