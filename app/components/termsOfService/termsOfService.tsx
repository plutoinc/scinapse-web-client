    ...
    return (
      <div className={styles.termsOfServiceContainer}>
        ...
        <p className={styles.contents}>
          ...
          to build an ecosystem where knowledge pieces in science and research are promoted to be openly shared and then
          to enable further studies. We are very much happy to have you ("you", "your", "yours", "yourself", or the
          "user") as a researcher, author, reviewer, reader, or contributor to the ecosystem, and welcome you to join
          the community. Before engaging in any activity pertaining to Pluto Network, we want you to thoroughly read and
          agree to the following Terms of Service (the "Terms"). By agreeing to the Terms, you understand that you may
          be governed under the laws and legislation of any or all of the regions (i) where you live, (ii) where you
          view or edit content on our services, (iii) where other users view your content, or (iv) where other users who
          view your content live, which may include the law in the Republic of Korea where we are based ("applicable
          law").
        </p>
        ...
        <p className={styles.contents}>
          ...
          Websites, you agree to comply with the Terms. If you do not agree to the Terms, you may not access or use the
          Services and/or our Websites.
        </p>
        ...
        <p className={styles.contents}>
          The Services mainly depend on content voluntarily shared by researchers like yourself, but as most scientific
        ...
        <p className={styles.contents}>
          ...
          only exist with the support of the community of users like you who collaborate to write, edit, and curate the
          Content. We are happy to have you participate in this community. We ask you to be civil and polite in your
          interactions with others in the community, to act in good faith, and to make edits and contributions in
          alignment with our mission or with the purposes of the Services. Certain activities, whether legal or illegal,
          may be harmful to other users and violate our rules, and some activities may also subject you to liability.
          Therefore, for your own protection and for that of other users, you may not engage in such activities on the
          Services and/or our Websites. Under any circumstances you should NEVER do ANY of the followings:
        </p>
        <ul className={styles.bulletPoint}>
          ...
          <li>
            Posting or distributing content that contains any viruses, malware, worms, Trojan horses, malicious code, or
            other device that could harm our technical infrastructure or system or that of our users
          </li>
          <li>
            Engaging in automated uses of the Services that are abusive or disruptive of the Services and have not been
            approved by us
          </li>
          <li>
            Disrupting the Services by placing an undue burden on the Services or the networks or servers connected with
            the Services
          </li>
          <li>
            Disrupting the Services by inundating any of the Services with communications or other traffic that suggests
            no serious intent to use the Services for their stated purpose
          </li>
          <li>
        ...
        <p className={styles.contents}>
          ...
          the Services. Pluto Network rarely intervene in community decisions about protocols and their enforcement. In
        ...
        <ul className={styles.bulletPoint}>
          ...
          <li>
            Ban a user from editing or contributing or block a user's account or access for actions violating the Terms,
            including repeat copyright infringement
          </li>
          <li>
        ...
        <p className={styles.contents}>
          In the interests of our users and the Services, in the extreme circumstance that any individual has had their
          account or access blocked under this provision, they is prohibited from creating or using another account on
          or seeking access to the same Services, unless we provide explicit permission. Without limiting the authority
          of the community, we will not ban a user from editing or contributing or block a user's account or access
          solely because of good faith criticism that does not result in actions otherwise violating the Terms or the
          Services protocols.
        </p>
        <p className={styles.subtitle}>TRADEMARKS</p>
        <p className={styles.contents}>
          Although you have considerable freedoms for re-use of the Content on the Services under their licenses, it is
          important that we protect our trademark rights so that we can protect our users from fraudulent impersonators.
          Because of this, we ask that you please respect our trademarks. All trademarks related to Pluto Network,
          Scinapse, the Services and our Websites belong to us, Pluto Network, and any use of our trade names,
          trademarks, service marks, logos, or domain names must be in compliance with the Terms and applicable law.
        </p>
        ...
        <p className={styles.contents}>
          ...
          otherwise, you may still access our public pages for the sole purpose of reading publicly available content on
          the Services. In such circumstances, however, you may not be able to access your account or settings. We
        ...
        <p className={styles.contents}>
          ...
          AND WE EXPRESSLY DISCLAIM ALL WARRANTIES REGARDING THE SERVICES, EXPRESS, IMPLIED, STATUTORY, INCLUDING BUT
          NOT LIMITED TO THE IMPLIED WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, TITLE, SECURITY,
          ACCURACY, AND NON-INFRINGEMENT. WE MAKE NO WARRANTY THAT THE SERVICES WILL MEET YOUR REQUIREMENTS, BE SAFE,
          SECURE, UNINTERRUPTED, TIMELY, ACCURATE, OR ERROR-FREE, OR THAT YOUR INFORMATION WILL BE SECURE. WE ARE NOT
          RESPONSIBLE FOR THE CONTENT, DATA, OR ACTIONS OF THIRD PARTIES, AND YOU RELEASE US, OUR AFFILIATES, DIRECTORS,
          OFFICERS, EMPLOYEES, AGENTS, LICENSORS, AND PARTNERS FROM ANY CLAIMS AND DAMAGES, KNOWN AND UNKNOWN, ARISING
          OUT OF OR IN ANY WAY CONNECTED WITH ANY CLAIM YOU HAVE AGAINST ANY SUCH THIRD PARTIES. NO ADVICE OR
          INFORMATION, WHETHER ORAL OR WRITTEN, OBTAINED BY YOU FROM US OR THROUGH OR FROM THE SERVICES CREATES ANY
          WARRANTY NOT EXPRESSLY STATED IN THE TERMS. ANY MATERIAL DOWNLOADED OR OTHERWISE OBTAINED THROUGH YOUR USE OF
          THE SERVICES IS DONE AT YOUR OWN DISCRETION AND RISK, AND YOU WILL BE SOLELY RESPONSIBLE FOR ANY DAMAGE TO
          YOUR COMPUTER SYSTEM OR LOSS OF DATA THAT RESULTS FROM THE DOWNLOAD OF ANY SUCH MATERIAL. YOU AGREE THAT WE
          HAVE NO RESPONSIBILITY OR LIABILITY FOR THE DELETION OF, OR THE FAILURE TO STORE OR TO TRANSMIT, ANY CONTENT
          OR COMMUNICATION MAINTAINED BY THE SERVICES. WE RETAIN THE RIGHT TO CREATE LIMITS ON USE AND STORAGE AT OUR
          SOLE DISCRETION AT ANY TIME WITH OR WITHOUT NOTICE. SOME STATES OR JURISDICTIONS DO NOT ALLOW THE TYPES OF
          DISCLAIMERS IN THIS SECTION, SO THEY MAY NOT APPLY TO YOU EITHER IN PART OR IN FULL DEPENDING ON THE LAW.
        </p>

        <p className={styles.subtitle}>LIMITATION ON LIABILITY</p>
        <p className={styles.contents}>
          WE, PLUTO NETWORK, OUR AFFILIATES, DIRECTORS, OFFICERS, EMPLOYEES, AGENTS, LICENSORS, AND PARTNERS WILL NOT BE
          LIABLE TO YOU OR TO ANY OTHER PARTY FOR ANY DIRECT, INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL OR EXEMPLARY
          DAMAGES, INCLUDING BUT NOT LIMITED TO, DAMAGES FOR LOSS OF PROFITS, GOODWILL, USE, DATA, OR OTHER INTANGIBLE
          LOSSES, REGARDLESS OF WHETHER WE WERE ADVISED OF THE POSSIBILITY OF SUCH DAMAGE. IN THE CASE THAT APPLICABLE
          LAW MAY NOT ALLOW THE LIMITATION OR EXCLUSION OF LIABILITY OR INCIDENTAL OR CONSEQUENTIAL DAMAGES, THE ABOVE
          LIMITATION OR EXCLUSION MAY NOT APPLY TO YOU, ALTHOUGH OUR LIABILITY WILL BE LIMITED TO THE FULLEST EXTENT
          PERMITTED BY APPLICABLE LAW.
        </p>

        <p className={styles.subtitle}>DISPUTES AND JURISDICTIONS</p>
        <p className={styles.contents}>
          We hope that no serious disagreements arise involving you, but, in the event there is a dispute, we encourage
          you to seek resolution in coordination with the users community and us. If you seek to file a legal claim
          against us, you agree to file and resolve it exclusively in Seoul Central District Court located in 157
          Seochojungang-ro, Seocho-gu, Seoul 06594, Republic of Korea. You also agree that the laws of the Republic of
          Korea will govern the Terms, as well as any legal claim that might arise between you and us (without reference
          to conflict of laws principles). You agree to submit to the personal jurisdiction of, and agree that venue is
          proper in, Seoul Central District Court located in 157 Seochojungang-ro, Seocho-gu, Seoul 06594, Republic of
          Korea in any legal action or proceeding relating to us or the Terms. To ensure that disputes are dealt with
          soon after they arise, you agree that regardless of any statute or law to the contrary, any claim or cause of
          action you might have arising out of or related to use of the Services or the Terms must be filed within the
          applicable statute of limitations or, if earlier, within ONE (1) YEAR after the pertinent facts underlying
          such claim or cause of action could have been discovered with reasonable diligence. Otherwise, such cause of
        ...
        <p className={styles.contents}>
          ...
          time for receiving comments and embrace applicable ones. We may, however, fail to do so when the revisions are
          being made due to legal and administrative reasons. Though we will try to notice the users of changes in the
          Terms, it is your responsibility to check on any such changes in the Terms. We ask you to periodically review
          the most up-to-date version of the Terms from our Websites. Your continuing to access and use the Services or
          our Websites after the new version of the Terms take effect, whether you noticed it or not, constitutes an
          agreement to the new version of the Terms. For the sake of the Services, you, and other users, you cannot use
          the Services if you do not agree with the new version of the Terms.
        </p>
        ...
        <p className={styles.contents}>
          ...
          in the Terms between you and us, Pluto Network. If you have not signed a separate agreement with us, the Terms
          are the entire agreement between you and us. If there is any conflict between the Terms and a signed written
          agreement between you and us, the signed agreement will control. You understand that, unless otherwise agreed
          to in writing by us, you have no expectation of compensation for any activity, contribution, or idea that you
          provide to us, the community, or the Services. If any provision or part of a provision of the Terms is found
          unlawful, invalid, void, or unenforceable, that provision or part of the provision is deemed severable from
          the Terms and will be enforced to the maximum extent permissible with applicable law, and all other provisions
          of the Terms will remain in full force and effect. Our rights under the Terms will survive any termination of
          the Terms. In any circumstance, if we do not apply or enforce any provision of the Terms, it is not a waiver
          of that provision. Nor should it be considered a waiver of such provision when we fail to enforce any
          provision in the Terms. Notwithstanding any provision to the contrary in the Terms, we and you agree not to
          modify the applicable terms and requirements of any license that is employed on the Services or the Content
          when such license is authorized by the Terms. You agree that we may provide you with notices, including those
          regarding changes to the Terms, by email, regular mail, or postings on the Services or our Websites. The Terms
          were written in English. While we hope that translations of the Terms, if any, are accurate, in the event of
          any differences in meaning between the original English version and a translation, the original English
          version takes precedence. We may assign or delegate the Terms, in whole or in part, to any person or entity at
          any time with or without your consent. You may not assign or delegate any rights or obligations under the
          Terms without our prior written consent, and any unauthorized assignment and delegation by you is void.
        </p>
