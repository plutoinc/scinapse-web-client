...
workbox.routing.registerRoute(new RegExp("http://localhost:3000"), new workbox.strategies.NetworkFirst());
workbox.routing.registerRoute(new RegExp("https://dev.scinapse.io"), new workbox.strategies.NetworkFirst());
workbox.routing.registerRoute(new RegExp("https://scinapse.io"), new workbox.strategies.NetworkFirst());
workbox.routing.registerRoute(new RegExp("https://assets.pluto.network/(.*)"), new workbox.strategies.CacheFirst());
