export const ACTION_TYPES = {
  ...
  ARTICLE_SHOW_START_TO_GET_ARTICLE_DETAIL: Symbol("ARTICLE.SHOW_START_TO_GET_ARTICLE_DETAIL"),
  ARTICLE_SHOW_FAILED_TO_GET_ARTICLE_DETAIL: Symbol("ARTICLE.SHOW_FAILED_TO_GET_ARTICLE_DETAIL"),
  ARTICLE_SHOW_SUCCEEDED_TO_GET_ARTICLE_DETAIL: Symbol("ARTICLE.SHOW_SUCCEEDED_TO_GET_ARTICLE_DETAIL"),

  GLOBAL_DIALOG_OPEN: Symbol("GLOBAL.DIALOG_OPEN"),
  GLOBAL_DIALOG_CLOSE: Symbol("GLOBAL.DIALOG_CLOSE"),
  GLOBAL_CHANGE_DIALOG_TYPE: Symbol("GLOBAL.CHANGE_DIALOG_TYPE"),
};
