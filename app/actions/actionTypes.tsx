export const ACTION_TYPES = {
  ...
  SIGN_UP_SUCCEEDED_TO_CHECK_DUPLICATED_EMAIL: Symbol(
    "SIGN_UP_SUCCEEDED_TO_CHECK_DUPLICATED_EMAIL"
  ),
  SIGN_UP_FAILED_TO_CHECK_DUPLICATED_EMAIL: Symbol(
  ...
  SIGN_OUT_SUCCEEDED_TO_SIGN_OUT: Symbol("SIGN_OUT_SUCCESSED_TO_SIGN_OUT"),
  SIGN_OUT_FAILED_TO_SIGN_OUT: Symbol("SIGN_OUT_FAILED_TO_SIGN_OUT"),

  ARTICLE_FEED_TOGGLE_MODAL: Symbol("ARTICLE_FEED_TOGGLE_MODAL")
};
