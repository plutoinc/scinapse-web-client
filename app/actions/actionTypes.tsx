...
export enum ACTION_TYPES {
  ...
  AUTHOR_SHOW_START_TO_CONNECT_AUTHOR,
  AUTHOR_SHOW_SUCCEED_TO_CONNECT_AUTHOR,
  AUTHOR_SHOW_FAIL_TO_CONNECT_AUTHOR,
  ...
  AUTHOR_SHOW_TOGGLE_CONNECT_MEMBER_DIALOG,
  CONNECTED_AUTHOR_SHOW_START_TO_UPDATE_PROFILE_DATA,
  CONNECTED_AUTHOR_SHOW_SUCCEEDED_TO_UPDATE_PROFILE_DATA,
  CONNECTED_AUTHOR_SHOW_FAILED_TO_UPDATE_PROFILE_DATA,
  CONNECTED_AUTHOR_SHOW_START_TO_ADD_PAPER_TO_AUTHOR_PAPER_LIST,
  CONNECTED_AUTHOR_SHOW_SUCCEEDED_TO_ADD_PAPER_TO_AUTHOR_PAPER_LIST,
  CONNECTED_AUTHOR_SHOW_FAILED_TO_ADD_PAPER_TO_AUTHOR_PAPER_LIST,
  CONNECTED_AUTHOR_SHOW_START_TO_REMOVE_PAPER_FROM_AUTHOR_PAPER_LIST,
  CONNECTED_AUTHOR_SHOW_SUCCEEDED_TO_REMOVE_PAPER_FROM_AUTHOR_PAPER_LIST,
  CONNECTED_AUTHOR_SHOW_FAILED_TO_REMOVE_PAPER_FROM_AUTHOR_PAPER_LIST,
