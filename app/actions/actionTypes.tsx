export const ACTION_TYPES = {
  ...
  ARTICLE_SHOW_OPEN_PEER_EVALUATION_COMPONENT: Symbol("ARTICLE.SHOW_OPEN_PEER_EVALUATION_COMPONENT"),
  ARTICLE_SHOW_CLOSE_PEER_EVALUATION_COMPONENT: Symbol("ARTICLE.SHOW_CLOSE_PEER_EVALUATION_COMPONENT"),
