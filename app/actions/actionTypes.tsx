export const ACTION_TYPES = {
  ...
  SUCCEEDED_TO_FETCH_EVALUATIONS: Symbol("SUCCEEDED_TO_FETCH_EVALUATIONS"),
  ...
  PROFILE_START_TO_FETCH_USER_EVALUATIONS: Symbol("PROFILE.START_TO_FETCH_USER_EVALUATIONS"),
  PROFILE_FAILED_TO_FETCH_USER_EVALUATIONS: Symbol("PROFILE.FAILED_FETCH_USER_EVALUATIONS"),
  PROFILE_CLEAR_EVALUATIONS_TO_SHOW: Symbol("PROFILE.CLEAR_EVALUATIONS_TO_SHOW"),
  ...
  ARTICLE_SHOW_START_TO_VOTE_PEER_EVALUATION: Symbol("ARTICLE_SHOW.START_TO_VOTE_PEER_EVALUATION"),
  ARTICLE_SHOW_SUCCEEDED_TO_VOTE_PEER_EVALUATION: Symbol("ARTICLE_SHOW.SUCCEEDED_TO_VOTE_PEER_EVALUATION"),
  ARTICLE_SHOW_FAILED_TO_VOTE_PEER_EVALUATION: Symbol("ARTICLE_SHOW.FAILED_TO_VOTE_PEER_EVALUATION"),
  ARTICLE_SHOW_START_TO_GET_EVALUATIONS: Symbol("ARTICLE_SHOW.START_TO_GET_EVALUATIONS"),
  ARTICLE_SHOW_FAILED_TO_GET_EVALUATIONS: Symbol("ARTICLE_SHOW.FAILED_TO_GET_EVALUATIONS"),
