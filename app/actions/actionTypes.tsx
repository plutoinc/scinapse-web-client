export const ACTION_TYPES = {
  ...
  PROFILE_SUCCEEDED_FETCH_USER_ARTICLES: Symbol("PROFILE.SUCCEEDED_FETCH_USER_ARTICLES"),
  PROFILE_FAILED_FETCH_USER_ARTICLES: Symbol("PROFILE.FAILED_FETCH_USER_ARTICLES"),
