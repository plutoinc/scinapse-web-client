...
export enum ACTION_TYPES {
  ...
  ARTICLE_SEARCH_START_TO_GET_MY_FILTERS = "ARTICLE_SEARCH_START_TO_GET_MY_FILTERS",
  ARTICLE_SEARCH_SUCCEEDED_TO_GET_MY_FILTERS = "ARTICLE_SEARCH_SUCCEEDED_TO_GET_MY_FILTERS",
  ARTICLE_SEARCH_FAILED_TO_GET_MY_FILTERS = "ARTICLE_SEARCH_FAILED_TO_GET_MY_FILTERS",
  ARTICLE_SEARCH_START_TO_PUT_MY_FILTERS = "ARTICLE_SEARCH_START_TO_PUT_MY_FILTERS",
  ARTICLE_SEARCH_SUCCEEDED_TO_PUT_MY_FILTERS = "ARTICLE_SEARCH_SUCCEEDED_TO_PUT_MY_FILTERS",
  ARTICLE_SEARCH_FAILED_TO_PUT_MY_FILTERS = "ARTICLE_SEARCH_FAILED_TO_PUT_MY_FILTERS",
  ARTICLE_SEARCH_SET_FILTER_IN_MY_FILTER_SET = "ARTICLE_SEARCH_SET_FILTER_IN_MY_FILTER_SET",
