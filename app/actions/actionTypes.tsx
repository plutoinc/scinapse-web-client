export const ACTION_TYPES = {
  ...
  ARTICLE_CREATE_SUCCEEDED_TO_VALIDATE_STEP: Symbol("ARTICLE_CREATE.SUCCEEDED_TO_VALIDATE_STEP"),
  ARTICLE_CREATE_FAILED_TO_VALIDATE_STEP: Symbol("ARTICLE_CREATE.FAILED_TO_VALIDATE_STEP"),
