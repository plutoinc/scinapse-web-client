...
export enum ACTION_TYPES {
  ...
  ARTICLE_SEARCH_START_TO_GET_LOCAL_STORAGE_FILTERS = "ARTICLE_SEARCH_START_TO_GET_LOCAL_STORAGE_FILTERS",
  // tslint:disable-next-line:max-line-length
  ARTICLE_SEARCH_SUCCEEDED_TO_GET_LOCAL_STORAGE_FILTERS = "ARTICLE_SEARCH_SUCCEEDED_TO_GET_LOCAL_STORAGE_FILTERS",
  ARTICLE_SEARCH_FAILED_TO_GET_LOCAL_STORAGE_FILTERS = "ARTICLE_SEARCH_FAILED_TO_GET_LOCAL_STORAGE_FILTERS",
  ARTICLE_SEARCH_START_TO_PUT_LOCAL_STORAGE_FILTERS = "ARTICLE_SEARCH_START_TO_PUT_LOCAL_STORAGE_FILTERS",
  // tslint:disable-next-line:max-line-length
  ARTICLE_SEARCH_SUCCEEDED_TO_PUT_LOCAL_STORAGE_FILTERS = "ARTICLE_SEARCH_SUCCEEDED_TO_PUT_LOCAL_STORAGE_FILTERS",
  ARTICLE_SEARCH_FAILED_TO_PUT_LOCAL_STORAGE_FILTERS = "ARTICLE_SEARCH_FAILED_TO_PUT_LOCAL_STORAGE_FILTERS",
  ARTICLE_SEARCH_MERGE_LOCAL_TO_SERVER_FILTERS = "ARTICLE_SEARCH_MERGE_LOCAL_TO_SERVER_FILTERS",
