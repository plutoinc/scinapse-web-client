export const ACTION_TYPES = {
  ...
  MY_PAGE_SYNC_SETTING_INPUT_WITH_CURRENT_USER: Symbol("MY_PAGE.SYNC_SETTING_INPUT_WITH_CURRENT_USER"),
  MY_PAGE_CHANGE_PROFILE_IMAGE_INPUT: Symbol("MY_PAGE.CHANGE_PROFILE_IMAGE_INPUT"),
  MY_PAGE_UPDATE_CURRENT_USER_PROFILE_IMAGE: Symbol("MY_PAGE.UPDATE_CURRENT_USER_PROFILE_IMAGE"),
  MY_PAGE_UPDATE_CURRENT_USER_INSTITUTION: Symbol("MY_PAGE.UPDATE_CURRENT_USER_INSTITUTION"),
  MY_PAGE_UPDATE_CURRENT_USER_MAJOR: Symbol("MY_PAGE.UPDATE_CURRENT_USER_MAJOR"),

  MY_PAGE_CHANGE_INSTITUTION_INPUT: Symbol("MY_PAGE.CHANGE_INSTITUTION_INPUT"),
  MY_PAGE_CHANGE_MAJOR_INPUT: Symbol("MY_PAGE.CHANGE_MAJOR_INPUT"),
