export const ACTION_TYPES = {
  ...
  ARTICLE_SHOW_OPEN_PEER_EVALUATION_COMPONENT: Symbol("ARTICLE_SHOW_OPEN_PEER_EVALUATION_COMPONENT"),
  ARTICLE_SHOW_CLOSE_PEER_EVALUATION_COMPONENT: Symbol("ARTICLE_SHOW_CLOSE_PEER_EVALUATION_COMPONENT"),
