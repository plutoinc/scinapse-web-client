import { sourceDomain, dummy, figure, queryLover } from './abTestObject';
...
export type ABTest = 'sourceDomain' | 'dummy' | 'figure' | 'queryLover';
...
export const LIVE_TESTS: Test[] = [sourceDomain, dummy, figure, queryLover];
