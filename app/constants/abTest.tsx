import { searchItemImprovement, guruAtSearch, knowledgeBasedRecommend, sourceDomain } from './abTestObject';
...
export type ABTest = 'searchItemImprovement' | 'sourceDomain' | 'guruAtSearch' | 'knowledgeBasedRecommend';
...
export const LIVE_TESTS: Test[] = [searchItemImprovement, guruAtSearch, knowledgeBasedRecommend, sourceDomain];
