import { searchItemImprovement, guruAtSearch, knowledgeBasedRecommend, dummy } from './abTestObject';
...
export type ABTest = 'searchItemImprovement' | 'guruAtSearch' | 'knowledgeBasedRecommend' | 'dummy';
...
export const LIVE_TESTS: Test[] = [searchItemImprovement, guruAtSearch, knowledgeBasedRecommend, dummy];
