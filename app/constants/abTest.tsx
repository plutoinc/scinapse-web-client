import { dummy, queryLover, weightedCitation } from './abTestObject';
...
export type ABTest = 'dummy' | 'queryLover' | 'weightedCitation';
...
export const LIVE_TESTS: Test[] = [dummy, queryLover, weightedCitation];
