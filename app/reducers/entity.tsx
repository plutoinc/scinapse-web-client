  ...
  switch (action.type) {
    case ACTION_TYPES.GLOBAL_ADD_ENTITY:
      ...
      return {
        ...
        collections: { ...state.collections, ...entities.collections, ...entities.userCollections },
        userCollections: { ...state.userCollections, ...entities.userCollections, ...entities.collections },
